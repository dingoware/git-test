...
![Running the command.](./screenshots/returning-groups-and-users.png)
![Git config list.](./screenshots/git-config-list.png)
![Directory.](./screenshots/directory-files.png)

# HTTPS Server

![Double checking API.](./screenshots/api-post-with-webserver.png)
